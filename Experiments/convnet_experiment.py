...
@ex.named_config
def model64():
    RUN_NAME = 'CRPS-MODEL-64'
    DATA_DIR = 'netdata_64'
    PIC_WIDTH = 64

@ex.named_config
def noising_smoothing_labels():
    TRAIN_LABEL_NOISE_STD = 2.
    TRAIN_LABEL_SMOOTHING_STD = 3.

@ex.named_config
def sampling_space_time():
...
def svd_dimension():
    ...
    TRAIN_LABEL_SMOOTHING_STD = 2.
    DATA_AUGMENTATION = True
    DEPTH_1 = 40         # The output depth of the first convolutional layer
    DEPTH_2 = 80         # The output depth of the second convolutional layer
    DEPTH_3 = 150         # The output depth of the third convolutional layer
    DEPTH_4 = 120        # The output depth of the fourth convolutional layer
    DEPTH_5 = 30        # The output depth of the fifth convolutional layer
    #DEPTH_6 = 30         # The output depth of the last convolutional layer
    RUN_NAME = 'SVD-DIM-EXP'

@ex.named_config
def enlarged_augmentation_space_time():
    NUM_INPUTS = 9       # Number of input channels
    NUM_REPS = 144
...
@ex.named_config
def shifted_augmentation_space_time():
    NUM_INPUTS = 9       # Number of input channels
    NUM_REPS = 144
    TRAIN_LABEL_NOISE_STD = 0.0001
    TRAIN_LABEL_SMOOTHING_STD = 0.
    DATA_AUGMENTATION = True
    SHIFT = True
    RUN_NAME = 'SHIFT-AUG-EXP3'

@ex.named_config
def new_shifted_augmentation():
    NUM_INPUTS = 9       # Number of input channels
    NUM_REPS = 144
    TRAIN_LABEL_NOISE_STD = 0.0001
    TRAIN_LABEL_SMOOTHING_STD = 0.
...
def reduced_data():
    ...
    DATA_AUGMENTATION = True
    SHIFT = True
    RUN_NAME = 'RED-DATA-EXP'

@ex.named_config

def regularize_biases():
...
@ex.named_config
def relative_noise_reg():
    NUM_INPUTS = 9       # Number of input channels
    NUM_REPS = 144
    TRAIN_LABEL_NOISE_STD = .05
    TRAIN_LABEL_SMOOTHING_STD = .02
    mu = 0.001
    RUN_NAME = 'REL-NOISE-REG'
